...
def build_distance_table(graph, source):
    ...
    while len(priority_queue.keys()) > 0:
        ...
        for neighbor in graph.get_adjacent_vertices(current_vertex):
            ...
            # If there is an already present recorded distance from the source
            # greater than the distance of the new found path, then update the
            # current distance from the source in the distance table
