...
def spanning_tree(graph):
    ...
    # A dictionary mapping an edge pair to its weight
    ...
    # Map a node to all its adjacent nodes which are in the
    ...
    while len(priority_queue.keys()) and num_edges < graph.numVertices - 1:
        ...
        # vertex ID is always first, so that cycles are easily found
...
def has_cycle(spanning_tree):
    ...
    for source in spanning_tree:
        ...
        while len(q):
            ...
            # If this vertex has already been visited before
            ...
            # Add all vertices connected by edges in this
            # spanning tree
